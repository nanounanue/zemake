    ...
    if not self._counter:
      ...
      for b in self._buttons:
        if b.key == pygame.K_UP:
          self._buttons += [Event(pygame.KEYUP, key=pygame.K_UP)]
        if b.key == pygame.K_DOWN:
          self._buttons += [Event(pygame.KEYUP, key=pygame.K_DOWN)]
        if b.key == pygame.K_LEFT:
          self._buttons += [Event(pygame.KEYUP, key=pygame.K_LEFT)]
        if b.key == pygame.K_RIGHT:
          self._buttons += [Event(pygame.KEYUP, key=pygame.K_RIGHT)]
